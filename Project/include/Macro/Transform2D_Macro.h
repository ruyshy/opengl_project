...
void AddPosition(vec2 mPosition);																					\
vec2 GetPosition();																										\
...
void class_name::AddPosition(vec2 mPosition) { transform_name.mPosition.x +=mPosition.x;		\
transform_name.mPosition.y +=mPosition.y;}																	\
